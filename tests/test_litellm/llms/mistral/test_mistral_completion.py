...
@pytest.mark.asyncio
async def test_mistral_n_parameter_support(respx_mock, mistral_api_response):
    """
    Test that Mistral supports the 'n' parameter without throwing UnsupportedParamsError.
